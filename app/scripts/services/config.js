...
var conf_pruebas = {
  ...
  HOMOLOGACION_SERVICE:"https://autenticacion.udistrital.edu.co/apioas/dependencias_api/v1/",
    ...
    CLIENTE_ID: "ROUAiTnvTIQD5h45Iuj0kY3xmEEa",
        REDIRECT_URL: "http://10.20.254/resoluciones",
        RESPONSE_TYPE: "id_token token",
    SCOPE: "openid email documento",
        BUTTON_CLASS: "btn btn-warning btn-sm",
    SIGN_OUT_URL: "http://10.20.254/resoluciones",
    SIGN_OUT_REDIRECT_URL: "http://10.20.254/resoluciones",
        SIGN_OUT_APPEND_TOKEN: "true",
    },
    MENU_APP: [{
      id: "kronos",
